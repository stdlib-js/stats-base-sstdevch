...
```javascript
import sstdevch from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevch@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-sstdevch/tags). For example,

```javascript
import sstdevch from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevch@v0.2.2-esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-sstdevch.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-sstdevch

[test-image]: https://github.com/stdlib-js/stats-base-sstdevch/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-sstdevch/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-sstdevch/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-sstdevch?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-sstdevch.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-sstdevch/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-sstdevch/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-sstdevch/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-sstdevch/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-sstdevch/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-sstdevch/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-sstdevch/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-sstdevch/main/LICENSE
